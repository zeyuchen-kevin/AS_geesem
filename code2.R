...
#svMe      <- mean(c(Data$duration_1,Data$duration_2),na.rm=T)      # start value for mean
...
#https://github.com/OpenMx/OpenMx/blob/master/demo/UnivariateTwinAnalysis_MatrixRaw.R
